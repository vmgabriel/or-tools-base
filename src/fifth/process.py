...
def create_data_model() -> dict:
    """Load all data Model"""
    data = {}
    file_path = 'src/fifth/data.csv'
    data['distance_matrix'] = read_csv(file_path)
    data['num_vehicles'] = 4
    data['depot'] = 0

    # The coordinates is not included in the problem data
    # I resolve the matrix of distance this is pre-computed
    # The distances between locations are colculated using Manhattan distance
    return data
