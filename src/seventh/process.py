"""
Process control for capacity constraints
"""
...
def create_data_model() -> dict:
    """Create_data_model"""
    data = {}
    file_path = 'src/seventh/data.csv'
...
def run():
    ...
    # Defineconst of each arc.
    routing.SetArcCostEvaluatorOfAllVehicles(transit_callback_index)

    # Add Capacity contraints.
    def demand_callback(from_index):
        """Returns the demand of the node"""
        # convert fro routing variable index to demands NodeIndex
        from_node = manager.IndexToNode(from_index)
    ...
    routing.AddDimensionWithVehicleCapacity(
        ...
        data['vehicle_capacities'],  # vehicle maximum
        True,  # start from zero
        'Capacity'
    )

    # Setting first solution heurisitc
